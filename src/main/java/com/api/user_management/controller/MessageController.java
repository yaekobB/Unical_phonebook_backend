...
public class MessageController {
	...
	public MessageResponseModel updateMessages(@RequestBody MessageRequestModel messageDetails, @PathVariable Long messageId) {
		MessageResponseModel returnValue = messagesService.updateMessage(messageId, messageDetails);
		return returnValue;
	}
	
	@GetMapping(path = "/{messageId}")
	public MessageResponseModel getMessage(@PathVariable Long messageId) {
		MessageResponseModel returnValue = messagesService.getMessage(messageId);
		return returnValue;
	}
	...
	public List<MessageResponseModel> getMessages(
			...
			@RequestParam(value="senderId", defaultValue = "0") Long senderId,			
			@RequestParam(value="recieverId", defaultValue = "0") Long recieverId
			) {
		List<MessageResponseModel> returnValue = messagesService.getMessages(searchKey,page,limit,senderId, recieverId);
		return returnValue;
	}
	...
	public MessageResponseModel saveChatRoomMessages(@RequestBody MessageRequestModel messagesDetail) {
